...
package org.dromara.soul.examples.http.controller;

import org.dromara.soul.client.springmvc.annotation.SoulSpringMvcClient;
import org.dromara.soul.examples.http.dto.UserDTO;
import org.springframework.web.bind.annotation.*;

/**
 * HttpTestFallbackController.
 *
 * @author Silencksk
 */
@RestController
@RequestMapping("/testFallback")
@SoulSpringMvcClient(path = "/testFallback/**")
public class HttpTestFallbackController {
    ...
    public UserDTO findByUserId(@RequestParam("userId") final String userId) {
        ...
        userDTO.setUserName("hello world<===fallback");
        return userDTO;
    }
